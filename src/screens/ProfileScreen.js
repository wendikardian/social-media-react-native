    ...
    <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.mainContainer}>
            ...
            <View style={styles.inputContainer}>
                <Input title="username" editable={false} value={globalData.username} />
                <Input title="Email" editable={false} value={globalData.email} />
                <Input title="Password" editable={false} value={globalData.password} />
            </View>
            <Button text="Logout" isLogout={true} onPress={() => setIsModalVisible(true)} />
                ...
                <View style={styles.backgroundView}>
                    <View style={styles.modalView}>
                        ...
                        <View style={styles.modalButton}>
                            ...
                            <Button text="No" isLogout={true} onPress={() => setIsModalVisible(false)} />
                        </View>
                    </View>
                </View>
            </Modal>
